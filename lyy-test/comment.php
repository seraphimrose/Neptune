...
<div class="menu_title">
    <h1 style="text-align: center;color:red">吐槽！</h1>
    <hr/>
</div>
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="menu_items">
            <div class="row">
                <div class="col-md-12"><textarea class="form-control tc-input" name="new-tc" type="text" style=""/>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-primary tc-submit">吐了个槽</button>
                </div>
                <div class="col-md-5"></div>
            </div>
            <div class="row"><p></p></div>
